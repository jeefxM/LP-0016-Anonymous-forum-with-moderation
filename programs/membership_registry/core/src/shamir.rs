...
//!
//! VENDORED COPY of `post_proof_core::shamir`. Duplicated (not a path dep)
//! because the membership_registry guest's docker build context can't reach
//! ../../post_proof/core. The cross-check test
//! `slash-evidence::vendored_shamir_matches_original` asserts this copy and
//! the original produce identical shares. If you edit one, edit both.
//!
//! ## Construction
//!
